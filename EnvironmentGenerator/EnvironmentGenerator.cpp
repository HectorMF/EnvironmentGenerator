...
int main(int argc, char** argv)
{
	int width1, height1;
	int n;
	float *rgb = stbi_loadf("C:\\Users\\Hector\\Documents\\Gearbox\\bin\\Resources\\Environments\\neuroArm-panorama.hdr", &width1, &height1, &n, 0);
	if (!rgb || n != 3) {
		return -1;
	}


	const char* input = "C:\\Users\\Hector\\Documents\\Gearbox\\bin\\Resources\\Environments\\neuroArm-panorama.exr";
	...
	tex = gli::texture2d(gli::FORMAT_RGBA32_SFLOAT_PACK32, gli::extent2d(width, height), 1);
	...
	for (int y = 0; y < height; y++)
	{
		for (int x = 0; x < width; x++, ++o)
		{
			...
			tex.store<glm::vec4>({ x,  y }, 0,  glm::vec4(r, g, b, a));
		}
	}

	gli::save(tex, "C:\\Users\\Hector\\Documents\\Gearbox\\bin\\Resources\\Environments\\test.dds");
